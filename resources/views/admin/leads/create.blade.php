    ...
    <div class="card-body">
        <form action="{{ route('admin.leads.store') }}" method="POST">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="service_type" class="form-select @error('service_type') is-invalid @enderror" required>
                            ...
                            <option value="fintech-software" {{ old('service_type') == 'fintech-software' ? 'selected' : '' }}>Fintech Software</option>
                            <option value="mobile-app" {{ old('service_type') == 'mobile-app' ? 'selected' : '' }}>Mobile App</option>
                            <option value="web-development" {{ old('service_type') == 'web-development' ? 'selected' : '' }}>Web Development</option>
                            <option value="api-integration" {{ old('service_type') == 'api-integration' ? 'selected' : '' }}>API Integration</option>
                            <option value="e-commerce" {{ old('service_type') == 'e-commerce' ? 'selected' : '' }}>E-commerce</option>
                            <option value="ui-ux" {{ old('service_type') == 'ui-ux' ? 'selected' : '' }}>UI/UX Design</option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="budget" class="form-select @error('budget') is-invalid @enderror" required>
                            ...
                            <option value="50k-100k" {{ old('budget') == '50k-100k' ? 'selected' : '' }}>₹50,000 - ₹1,00,000</option>
                            <option value="100k-500k" {{ old('budget') == '100k-500k' ? 'selected' : '' }}>₹1,00,000 - ₹5,00,000</option>
                            <option value="500k+" {{ old('budget') == '500k+' ? 'selected' : '' }}>₹5,00,000+</option>
                        </select>
            ...
            <div class="form-group">
                ...
                <textarea name="project_description" rows="5" class="form-control @error('project_description') is-invalid @enderror" required>{{ old('project_description') }}</textarea>
