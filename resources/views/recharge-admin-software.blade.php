...
@section('title', 'Recharge Admin Software')
                ...
                <div class="bre-sub">
                    <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Home."
                        ...
                        <meta property="position" content="1">
                            ...
                            class="post post-page current-item">Recharge Admin Software</span>
                    </span>
                </div>
            </div>
        </div>
    ...
    <section class="fnx-service-grid-section">
        <div class="container">
            <div class="fnx-title-box text-center">
                <h6 class="fnx-subtitle">Recharge Management Solutions</h6>
                <h2 class="fnx-main-title">Smart Recharge Portal with Multi-Operator Support</h2>
            </div>
                    ...
                    <div class="fnx-card-six fnx-transition">
                        ...
                        <div class="fnx-card-body fnx-transition">
                            ...
                            <div class="fnx-card-content fnx-transition">
                                <h3 class="fnx-card-title fnx-transition">Multi-Operator Recharge APIs</h3>
                                <div class="fnx-card-text fnx-transition">
                                    <p>Support for Mobile, DTH, Data Card, and Postpaid Bills from multiple operators in one platform.</p>
                                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="fnx-card-six fnx-transition">
                        ...
                        <div class="fnx-card-body fnx-transition">
                            ...
                            <div class="fnx-card-content fnx-transition">
                                <h3 class="fnx-card-title fnx-transition">Admin + Distributor + Retailer Panel</h3>
                                <div class="fnx-card-text fnx-transition">
                                    <p>Customizable user roles with dedicated panels for admin, distributors, and retailers management.</p>
                                </div>
                                <div class="fnx-card-btn">
                                    <a href="{{ route('contact') }}" class="btn-primary-custom btn-custom-round">Learn More <i
                                            class="fa-solid fa-arrow-right"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="fnx-card-six fnx-transition">
                        ...
                        <div class="fnx-card-body fnx-transition">
                            ...
                            <div class="fnx-card-content fnx-transition">
                                <h3 class="fnx-card-title fnx-transition">Wallet Management & Commission Setup</h3>
                                <div class="fnx-card-text fnx-transition">
                                    <p>Real-time wallet balance, automated commission calculations, and flexible commission structures.</p>
                                </div>
                                <div class="fnx-card-btn">
                                    <a href="{{ route('contact') }}" class="btn-primary-custom btn-custom-round">Learn More <i
                                            class="fa-solid fa-arrow-right"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="fnx-card-six fnx-transition">
                        ...
                        <div class="fnx-card-body fnx-transition">
                            ...
                            <div class="fnx-card-content fnx-transition">
                                <h3 class="fnx-card-title fnx-transition">Recharge Reports with Advanced Filters</h3>
                                <div class="fnx-card-text fnx-transition">
                                    <p>Comprehensive transaction reports with advanced filters for detailed analytics and business insights.</p>
                                </div>
                                <div class="fnx-card-btn">
                                    <a href="{{ route('contact') }}" class="btn-primary-custom btn-custom-round">Learn More <i
                                            class="fa-solid fa-arrow-right"></i></a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="fnx-about-content">
                        <h6 class="restly-about-stitle"><span>Recharge Solutions</span></h6>
                        <h2 class="restly-about-title">Complete Recharge Management Platform for Your Business</h2>
                        <div class="restly-about-dec">
                            <p>Our Recharge Admin Software is designed to simplify multi-recharge services like Mobile, DTH, Data Card, and Postpaid Bills from a single admin interface. Manage agents, commissions, recharges, and reports easily with our white-label portal.</p>
                            <ul>
                                <li>White-label recharge portal with custom branding</li>
                                <li>Seamless SMS integration for notifications</li>
                                <li>Scalable infrastructure for high-volume transactions</li>
                            </ul>
                        </div>
                        <div class="fnx-button-area">
                            <a href="{{ route('contact') }}" class="theme-btns">Launch Your Recharge Business</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="fnx-image-box">
                        <img loading="lazy" src="{{ asset('assets/img/about.webp') }}" class="fnx-main-img" alt="Recharge Software">
        ...
        <div class="container">
            ...
            <div class="restly-section-title-wrapper">
                <div class="restly-section-title">
                    ...
                    <h2 class="restly-section-title">How We Develop Your Recharge System</h2>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="fnx-process-card">
                            ...
                            <h2 class="fnx-title">Gathering Requirements</h2>
                            <div class="fnx-desc">
                                <p>We discuss your business model, operator APIs, user roles, and specific recharge requirements.</p>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="fnx-process-card">
                            ...
                            <h2 class="fnx-title">Design & Panel Setup</h2>
                            <div class="fnx-desc">
                                <p>We customize user panels with your branding, commission logic, and operational workflows.</p>
                            </div>
                            <a href="{{ route('contact') }}" class="fnx-btn">Learn More <i class="fas fa-arrow-right"></i></a>
                    ...
                    <div class="col-lg-4">
                        <div class="fnx-process-card">
                            ...
                            <h2 class="fnx-title">API Integration</h2>
                            <div class="fnx-desc">
                                <p>All recharge APIs are integrated securely and mapped to operators for seamless operations.</p>
                            </div>
                            <a href="{{ route('contact') }}" class="fnx-btn">Learn More <i class="fas fa-arrow-right"></i></a>
            ...
            <div class="row" style="margin-top: 40px;">
                <div class="col-lg-12">
                    <div class="fnx-process-card" style="text-align: center;">
                        ...
                        <h2 class="fnx-title">Testing & Go Live</h2>
                        <div class="fnx-desc">
                            <p>Final testing is conducted with demo credits, and the system is launched to production.</p>
                        </div>
                        <a href="{{ route('contact') }}" class="fnx-btn">Learn More <i class="fas fa-arrow-right"></i></a>
            ...
            <div class="fnx-contact-inner-wrapper">
                <div class="row">
                    <div class="col-lg-8 fnx-form-column">
                        <div class="restly-section-title-wrapper">
                            <div class="restly-section-title">
                                <h2 class="restly-section-title">Start Your Recharge Platform</h2>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="restly-input message">
                                            <textarea name="message" rows="4" placeholder="Tell us about your recharge business requirements."></textarea>
                                        </div>
