...
@section('title', 'UI/UX & Web Design')
                ...
                <div class="bre-sub">
                    <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Home."
                        ...
                        <meta property="position" content="1">
                            ...
                            class="post post-page current-item">UI/UX & Web Design</span>
                    </span>
                </div>
            </div>
        </div>
    ...
    <section class="fnx-service-grid-section">
        <div class="container">
            <div class="fnx-title-box text-center">
                <h6 class="fnx-subtitle">Design Solutions</h6>
                <h2 class="fnx-main-title">Creative UI/UX & Modern Web Design Services</h2>
            </div>
                    ...
                    <div class="fnx-card-six fnx-transition">
                        ...
                        <div class="fnx-card-body fnx-transition">
                            ...
                            <div class="fnx-card-content fnx-transition">
                                <h3 class="fnx-card-title fnx-transition">Research-based Wireframes</h3>
                                <div class="fnx-card-text fnx-transition">
                                    <p>Data-driven wireframes based on user research and business goals analysis.</p>
                                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="fnx-card-six fnx-transition">
                        ...
                        <div class="fnx-card-body fnx-transition">
                            ...
                            <div class="fnx-card-content fnx-transition">
                                <h3 class="fnx-card-title fnx-transition">Clickable Prototypes</h3>
                                <div class="fnx-card-text fnx-transition">
                                    <p>Interactive prototypes to test user flows and gather feedback before development.</p>
                                </div>
                                <div class="fnx-card-btn">
                                    <a href="{{ route('contact') }}" class="btn-primary-custom btn-custom-round">Learn More <i
                                            class="fa-solid fa-arrow-right"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="fnx-card-six fnx-transition">
                        ...
                        <div class="fnx-card-body fnx-transition">
                            ...
                            <div class="fnx-card-content fnx-transition">
                                <h3 class="fnx-card-title fnx-transition">Custom Website & App Designs</h3>
                                <div class="fnx-card-text fnx-transition">
                                    <p>Beautiful, brand-aligned visual designs with typography, colors, and iconography.</p>
                                </div>
                                <div class="fnx-card-btn">
                                    <a href="{{ route('contact') }}" class="btn-primary-custom btn-custom-round">Learn More <i
                                            class="fa-solid fa-arrow-right"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="fnx-card-six fnx-transition">
                        ...
                        <div class="fnx-card-body fnx-transition">
                            ...
                            <div class="fnx-card-content fnx-transition">
                                <h3 class="fnx-card-title fnx-transition">Mobile-first & Responsive Design</h3>
                                <div class="fnx-card-text fnx-transition">
                                    <p>Designs optimized for all devices with mobile-first approach and seamless responsiveness.</p>
                                </div>
                                <div class="fnx-card-btn">
                                    <a href="{{ route('contact') }}" class="btn-primary-custom btn-custom-round">Learn More <i
                                            class="fa-solid fa-arrow-right"></i></a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="fnx-about-content">
                        <h6 class="restly-about-stitle"><span>Design Excellence</span></h6>
                        <h2 class="restly-about-title">Intuitive User Experiences Through Expert Design</h2>
                        <div class="restly-about-dec">
                            <p>Finext Solution delivers intuitive and engaging user experiences through expert UI/UX design strategies. Our team blends creativity with business logic to create beautiful interfaces that drive engagement and conversions. We use industry-leading tools like Figma, Adobe XD, and Sketch to turn ideas into stunning digital products.</p>
                            <ul>
                        ...
                        <div class="fnx-button-area">
                            <a href="{{ route('contact') }}" class="theme-btns">Discuss Your Design</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="fnx-image-box">
                        <img loading="lazy" src="{{ asset('assets/img/about.webp') }}" class="fnx-main-img" alt="UI/UX Design">
        ...
        <div class="container">
            ...
            <div class="restly-section-title-wrapper">
                <div class="restly-section-title">
                    <h6 class="restly-section-stitle"><span>Design Process</span></h6>
                    <h2 class="restly-section-title">Our UI/UX Design Workflow</h2>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="fnx-process-card">
                            ...
                            <h2 class="fnx-title">Discovery & Research</h2>
                            <div class="fnx-desc">
                                <p>We analyze your business goals, target audience, and competitors to inform design decisions.</p>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="fnx-process-card">
                            ...
                            <h2 class="fnx-title">Wireframing</h2>
                            <div class="fnx-desc">
                                <p>Blueprint of your product's structure with key screens and user flows defined.</p>
                            </div>
                            <a href="{{ route('contact') }}" class="fnx-btn">Learn More <i class="fas fa-arrow-right"></i></a>
                    ...
                    <div class="col-lg-4">
                        <div class="fnx-process-card">
                            ...
                            <h2 class="fnx-title">Visual Design</h2>
                            <div class="fnx-desc">
                                <p>Brand colors, typography, iconography, and layouts are finalized with stunning visuals.</p>
                            </div>
                            <a href="{{ route('contact') }}" class="fnx-btn">Learn More <i class="fas fa-arrow-right"></i></a>
            ...
            <div class="row" style="margin-top: 40px;">
                <div class="col-lg-12">
                    <div class="fnx-process-card" style="text-align: center;">
                        ...
                        <h2 class="fnx-title">Prototype & Handoff</h2>
                        <div class="fnx-desc">
                            <p>Interactive prototypes shared with developers for seamless implementation and handoff.</p>
                        </div>
                        <a href="{{ route('contact') }}" class="fnx-btn">Learn More <i class="fas fa-arrow-right"></i></a>
            ...
            <div class="fnx-contact-inner-wrapper">
                <div class="row">
                    <div class="col-lg-8 fnx-form-column">
                        <div class="restly-section-title-wrapper">
                            <div class="restly-section-title">
                                <h2 class="restly-section-title">Get Your Design Project Started</h2>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="restly-input message">
                                            <textarea name="message" rows="4" placeholder="Tell us about your design needs and project vision."></textarea>
                                        </div>
